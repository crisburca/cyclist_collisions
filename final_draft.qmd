...
Since I am comparing pedestrian and cyclist collisions, I have filtered the data to show only pedestrian and cyclist collisions, and have selected the variables 'Date' and 'Injury' to study. 'Date' is formatted as YYYY-MM-DD and 'Injury' lists the severity of the injury from 'None', 'Minimal', 'Minor', 'Major' and 'Fatal'. I then created two new columns titled 'Year' and 'Month', to seperate the year and month information to allow for easier comparison of years and months. 
